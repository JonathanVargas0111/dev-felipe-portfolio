...
import { ArrowDown, ArrowUpRight, Code, Database, Cpu, Layers } from 'lucide-react';
...
export default function HeroSection() {
  ...
  return (
    <section id="home" className="pt-32 pb-20 lg:pt-40 lg:pb-28 relative">
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 space-y-12 sm:space-y-16">
        
        {/* Editorial Top Metadata Ribbon */}
        <div className="flex flex-wrap items-center justify-between gap-3 text-[11px] font-mono uppercase tracking-wider text-slate-500 dark:text-slate-400 border-b border-black/[0.06] dark:border-white/[0.06] pb-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-slate-800 dark:text-slate-200">AVAILABLE FOR ROLES & CONTRACTS</span>
          </div>
        </div>

        {/* Main Editorial Headline */}
        <div className="space-y-6 max-w-5xl">
          <h1 className="text-4xl sm:text-6xl lg:text-7xl font-sans font-extrabold tracking-tight text-slate-950 dark:text-white leading-[1.08]">
            Felipe Vargas.
            <span className="block font-editorial italic font-normal text-3xl sm:text-5xl lg:text-6xl text-slate-700 dark:text-slate-300 mt-2">
              Engineering high-resilience web systems, custom e-commerce & AI workflows.
            </span>
          </h1>

          <p className="text-base sm:text-lg text-slate-600 dark:text-slate-400 max-w-3xl leading-relaxed font-normal">
            {t.description}
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 pt-4 items-start">
          ...
          <div className="lg:col-span-5 space-y-8">
            ...
            <div className="flex flex-wrap items-center gap-3 pt-2">
              <a
                href="#projects"
                className="inline-flex items-center gap-2 px-5 py-3 rounded-lg bg-slate-950 dark:bg-white text-white dark:text-slate-950 text-xs font-mono font-semibold hover:opacity-90 transition-opacity"
              >
              ...
              <a
                href="#contact"
                className="inline-flex items-center gap-2 px-5 py-3 rounded-lg border border-black/10 dark:border-white/15 text-slate-800 dark:text-slate-200 text-xs font-mono hover:bg-black/[0.04] dark:hover:bg-white/[0.06] transition-colors"
              >
          ...
          <div className="lg:col-span-7">
            <div className="p-6 sm:p-8 rounded-2xl bg-surface-light dark:bg-surface-dark border border-black/[0.08] dark:border-white/[0.08] space-y-6">
              ...
              <div className="divide-y divide-black/[0.06] dark:divide-white/[0.06]">
                {verifiedMetrics.map((m) => (
                  <div key={m.key} className="py-3.5 flex flex-col sm:flex-row sm:items-baseline justify-between gap-1">
                    ...
                    <div className="text-lg sm:text-xl font-mono font-bold text-slate-950 dark:text-white sm:text-right">
                      {m.value}
                    </div>
                  </div>
                ))}
              ...
              <div className="pt-2 border-t border-black/[0.06] dark:border-white/[0.06] flex items-center justify-between text-[11px] font-mono text-slate-500 dark:text-slate-400">
