...
export default function AboutSection() {
  ...
  return (
    <section id="about" className="py-24 lg:py-32 relative border-t border-black/[0.06] dark:border-white/[0.06]">
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 space-y-12 sm:space-y-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
          ...
          <div className="lg:col-span-6 space-y-6 text-sm sm:text-base leading-relaxed text-slate-700 dark:text-slate-300 font-normal">
          ...
          <div className="lg:col-span-6 space-y-6">
            ...
            <div className="p-6 rounded-2xl border border-black/[0.06] dark:border-white/[0.06] bg-black/[0.02] dark:bg-white/[0.02] space-y-2 font-mono text-xs">
