...
export default function Footer() {
  ...
  return (
    <footer className="border-t border-black/[0.08] dark:border-white/[0.08] bg-surface-light dark:bg-surface-dark py-12 text-slate-500 font-mono text-xs">
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 space-y-8">
        ...
        <div className="flex flex-col sm:flex-row items-baseline justify-between gap-4">
          ...
          <div className="flex items-center gap-6 text-xs">
            ...
            <button
              onClick={scrollToTop}
              className="flex items-center gap-1 hover:text-slate-950 dark:hover:text-white transition-colors ml-4"
            >
              <span>TOP</span>
        ...
        <div className="pt-6 border-t border-black/[0.05] dark:border-white/[0.05] flex flex-col sm:flex-row sm:items-center justify-between gap-3 text-[11px] text-slate-400">
