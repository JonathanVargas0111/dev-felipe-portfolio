...
export default function NandarkLabSection() {
  ...
  return (
    <section id="nandark" className="py-20 sm:py-24 lg:py-32 relative border-t border-black/[0.06] dark:border-white/[0.06]">
      <div className="max-w-7xl mx-auto px-4 sm:px-8 lg:px-12 space-y-10 sm:space-y-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-14 items-start">
          ...
          <div className="lg:col-span-6 space-y-5 sm:space-y-6">
            ...
            <div className="p-5 sm:p-6 rounded-2xl border border-black/[0.08] dark:border-white/[0.08] bg-surface-light dark:bg-surface-dark space-y-2.5 sm:space-y-3">
              <div className="flex items-baseline justify-between">
                <span className="font-mono text-xl sm:text-3xl font-bold text-slate-950 dark:text-white">
                  39+ Articles
                </span>
                <span className="font-mono text-[10px] sm:text-xs text-slate-400 uppercase">PUBLISHED IN PROD</span>
              </div>
            ...
            <div className="flex flex-wrap items-center gap-3 pt-2">
              <a
                ...
                className="inline-flex items-center gap-2 px-4 py-2.5 sm:px-5 sm:py-2.5 rounded-lg bg-slate-950 dark:bg-white text-white dark:text-slate-950 text-xs font-mono font-semibold hover:opacity-90 transition-opacity"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-1.5 px-3.5 py-2.5 sm:px-4 sm:py-2.5 rounded-lg border border-black/10 dark:border-white/15 text-slate-800 dark:text-slate-200 text-xs font-mono hover:bg-black/[0.04] dark:hover:bg-white/[0.06] transition-colors"
              >
            ...
            {t.tools.map((tool, idx) => (
              ...
              >
                <div className="flex items-center justify-between font-mono text-xs">
                  ...
                  <span className="text-slate-400 text-[10px] sm:text-xs">OPEN / LIVE</span>
                </div>
